...
# Imputação: aqui está o código para realizar a imputação, mas ñ o acabámos 
# por usar, pois por imputação ficava muito pior
#
#
# for (X in c(2:20)) {
...
best.fitbic<-c(1,3,4,6,9,12,14,19,20) #já sem a under.five.deaths, que era desnecessária por ter problemas claros de multicolinearidade
...
#best.fitbic<-c(1,3,6,9,10,12,14,19,20) ######################## AAAAAAAAAAAAAAA
